...
const C = {
  ...
  de: {
    ...
    wuduSub: "Wie in der Wudu des Propheten ﷺ beschrieben, überliefert von 'Uthman ibn 'Affan (Sahih al-Bukhari 164, Sahih Muslim 226). Wasche jeden Teil der Reihe nach, ohne lange Pausen dazwischen.",
    thStep: 'Schritt',
    thHow: 'Wie',
    thTimes: 'Male',
    breaks: 'Was bricht die Wudu?',
    breaksTail: 'Tritt eines davon ein, wiederhole einfach die Wudu vor dem nächsten Gebet.',
    ...
    sealTitle: 'Die Dua nach der Wudu',
    purityTitle: '🚿 Vor der Wudu kommt die Istinja',
    purity: 'Die Wudu ist nur an einem Körper gültig, der nach der Toilette gereinigt wurde. Wie man sich richtig mit Wasser reinigt, was bei Urintropfen, Zweifeln, Handtüchern und mehr zu tun ist — wir beantworten alles offen auf der eigenen Seite:',
  ...
  tr: {
    ...
    purityLink: 'Temizlik ve Paklık — eksiksiz rehber →',
  },
  ur: {
    title: 'نماز سے پہلے',
