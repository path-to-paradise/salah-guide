...
const topics = [
  ...
  },
  {
    icon: '🤲',
    title: {
      en: 'Best times to make dua',
      bg: 'Най-добрите моменти за дуа',
      fr: 'Les meilleurs moments pour faire une dua',
      de: 'Die besten Zeiten für Dua',
      nl: 'De beste tijden om doea te maken',
      tr: 'Dua etmenin en hayırlı vakitleri',
      ur: 'دعا کے لیے بہترین اوقات',
    },
    body: {
      en: [
        '“In the last third of the night, Allah descends to the lowest heaven and says: Who is calling upon Me, that I may answer him?” (Sahih al-Bukhari 1145)',
        'Between the adhan and the iqamah — a dua made in this window is not rejected (Jami\' at-Tirmidhi 212).',
        'While prostrating (sujud) — a servant is closest to his Lord then, so ask often (Sahih Muslim 482).',
        'An hour on Friday, somewhere between the imam sitting down and the prayer ending, when any request is granted (Sahih al-Bukhari 935).',
        'While fasting, especially just before breaking the fast (Jami\' at-Tirmidhi 3598).',
        'On the Day of Arafah — the best of all duas (Jami\' at-Tirmidhi 3585).',
        'After the obligatory prayers, and in the last part of the night, are the times a dua is most likely to be answered (Jami\' at-Tirmidhi 3499, hasan).',
      ],
      bg: [
        '„В последната третина на нощта Аллах слиза до най-долното небе и казва: Кой Ме зове, за да му отговоря?“ (Сахих ал-Бухари 1145)',
        'Между езана и икамета — дуа, направена в този миг, не бива отхвърлена (Джами ат-Тирмизи 212).',
        'По време на седжде — робът е тогава най-близо до своя Господ, затова моли често (Сахих Муслим 482).',
        'Един час в петък, някъде между сядането на имама и края на намаза, когато всяка молба се приема (Сахих ал-Бухари 935).',
        'По време на говеене, особено точно преди ифтар (Джами ат-Тирмизи 3598).',
        'В деня на Арафат — най-добрата от всички дуи (Джами ат-Тирмизи 3585).',
        'След задължителните намази и в последната част на нощта дуата най-вероятно бива чута (Джами ат-Тирмизи 3499, хасен).',
      ],
      fr: [
        '« Dans le dernier tiers de la nuit, Allah descend au ciel le plus proche et dit : Qui M\'invoque, que Je lui réponde ? » (Sahih al-Bukhari 1145)',
        "Entre l'adhan et l'iqamah — une dua faite dans ce créneau n'est pas rejetée (Jami' at-Tirmidhi 212).",
        'Pendant la prosternation (sujud) — le serviteur est alors le plus proche de son Seigneur, alors demande souvent (Sahih Muslim 482).',
        "Une heure le vendredi, quelque part entre le moment où l'imam s'assoit et la fin de la prière, où toute demande est exaucée (Sahih al-Bukhari 935).",
        'Pendant le jeûne, surtout juste avant de le rompre (Jami\' at-Tirmidhi 3598).',
        'Le jour d\'Arafah — la meilleure de toutes les duas (Jami\' at-Tirmidhi 3585).',
        'Après les prières obligatoires, et dans la dernière partie de la nuit, sont les moments où une dua a le plus de chances d\'être exaucée (Jami\' at-Tirmidhi 3499, hasan).',
      ],
      de: [
        '„Im letzten Drittel der Nacht steigt Allah zum untersten Himmel herab und spricht: Wer ruft Mich an, dass Ich ihm antworte?“ (Sahih al-Bukhari 1145)',
        'Zwischen Adhan und Iqamah — eine in diesem Zeitfenster gemachte Dua wird nicht abgelehnt (Jami\' at-Tirmidhi 212).',
        'Während der Sujud (Niederwerfung) — der Diener ist seinem Herrn dann am nächsten, also bitte oft (Sahih Muslim 482).',
        'Eine Stunde am Freitag, irgendwo zwischen dem Hinsetzen des Imams und dem Ende des Gebets, in der jede Bitte erfüllt wird (Sahih al-Bukhari 935).',
        'Während des Fastens, besonders kurz vor dem Fastenbrechen (Jami\' at-Tirmidhi 3598).',
        'Am Tag von Arafah — die beste aller Duas (Jami\' at-Tirmidhi 3585).',
        'Nach den Pflichtgebeten und im letzten Teil der Nacht wird eine Dua am ehesten erhört (Jami\' at-Tirmidhi 3499, hasan).',
      ],
      nl: [
        '"In het laatste derde deel van de nacht daalt Allah neer naar de onderste hemel en zegt: Wie roept Mij aan, opdat Ik hem antwoord?" (Sahih al-Bukhari 1145)',
        'Tussen de adhan en de iqamah — een doea gemaakt in dit venster wordt niet afgewezen (Jami\' at-Tirmidhi 212).',
        'Tijdens de sujud (knieval) — de dienaar is dan het dichtst bij zijn Heer, vraag dus vaak (Sahih Muslim 482).',
        'Eén uur op vrijdag, ergens tussen het moment dat de imam gaat zitten en het einde van het gebed, waarop elk verzoek wordt ingewilligd (Sahih al-Bukhari 935).',
        'Tijdens het vasten, vooral vlak voordat het verbroken wordt (Jami\' at-Tirmidhi 3598).',
        'Op de Dag van Arafah — de beste van alle doea\'s (Jami\' at-Tirmidhi 3585).',
        'Na de verplichte gebeden en in het laatste deel van de nacht wordt een doea het meest waarschijnlijk verhoord (Jami\' at-Tirmidhi 3499, hasan).',
      ],
      tr: [
        '"Gecenin son üçte birinde Allah dünya semasına iner ve şöyle buyurur: Bana dua eden yok mu, duasına icabet edeyim?" (Sahih Buhari 1145)',
        "Ezan ile kamet arasında — bu aralıkta yapılan dua reddedilmez (Camiu't-Tirmizi 212).",
        'Secdedeyken — kul, Rabbine en yakın olduğu andadır, o yüzden sıkça dua et (Sahih Müslim 482).',
        'Cuma günü, imamın oturmasıyla namazın bitmesi arasında bir saat vardır ki, o anda yapılan her dilek kabul olur (Sahih Buhari 935).',
        "Oruçluyken, özellikle iftardan hemen önce (Camiu't-Tirmizi 3598).",
        'Arefe günü — duaların en hayırlısıdır (Camiu\'t-Tirmizi 3585).',
        "Farz namazlardan sonra ve gecenin son kısmı, duanın kabul olma ihtimalinin en yüksek olduğu vakitlerdir (Camiu't-Tirmizi 3499, hasen).",
      ],
      ur: [
        '"رات کے آخری تہائی حصے میں اللہ آسمانِ دنیا پر نزول فرماتا ہے اور کہتا ہے: کون ہے جو مجھے پکارے کہ میں اس کی دعا قبول کروں؟" (صحیح البخاری 1145)',
        'اذان اور اقامت کے درمیان — اس وقت کی گئی دعا رد نہیں کی جاتی (جامع ترمذی 212)۔',
        'سجدے کی حالت میں — بندہ اپنے رب کے سب سے قریب ہوتا ہے، اس لیے کثرت سے دعا کرو (صحیح مسلم 482)۔',
        'جمعہ کے دن ایک گھڑی، امام کے بیٹھنے اور نماز ختم ہونے کے درمیان کہیں، جس میں ہر مانگی ہوئی چیز عطا کی جاتی ہے (صحیح البخاری 935)۔',
        'روزے کی حالت میں، خاص طور پر افطار سے عین پہلے (جامع ترمذی 3598)۔',
        'عرفہ کے دن — تمام دعاؤں میں سب سے بہتر (جامع ترمذی 3585)۔',
        'فرض نمازوں کے بعد اور رات کے آخری حصے میں دعا کے قبول ہونے کا سب سے زیادہ امکان ہوتا ہے (جامع ترمذی 3499، حسن)۔',
      ],
    },
  },
]
