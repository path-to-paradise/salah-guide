...
const C = {
  ...
  fr: {
    ...
    methodSub: 'L\'objectif est simple : qu\'il ne reste aucune trace d\'urine ou de selles sur le corps, et que les dernières gouttes soient sorties avant que vous ne vous nettoyiez. Suivez la colonne qui vous concerne.',
    menTitle: '🚹 Pour les hommes',
    womenTitle: '🚺 Pour les femmes',
    methodNote: '⚠️ L\'équilibre, c\'est la Sunna : nettoyez-vous soigneusement une fois, puis arrêtez-vous. Les vérifications, pressions et lavages sans fin sont du waswas (chuchotements), pas de la piété — et le fiqh ci-dessous traite ce point directement.',
    forYou: 'Affiché pour vous — changez-le avec le bouton 👨/🧕 dans la barre du haut.',
  ...
  nl: {
    ...
    methodNote: '⚠️ Balans is de Soenna: reinig jezelf één keer grondig en stop dan. Eindeloos controleren, knijpen en opnieuw wassen is waswas (influistering), geen vroomheid — en de fiqh hieronder gaat hier rechtstreeks op in.',
  ...
  tr: {
    ...
    methodSub: 'Amaç basit: vücutta idrar veya dışkı izi kalmamalı ve temizlenmeden önce son damlalar da gitmiş olmalı. Size uygun olan sütunu takip edin.',
    menTitle: '🚹 Erkekler için',
    womenTitle: '🚺 Kadınlar için',
    methodNote: '⚠️ Denge sünnettir: bir kez iyice temizlenin, sonra durun. Sonu gelmeyen kontrol etme, sıkma ve tekrar yıkama vesvesedir, takva değil — aşağıdaki fıkıh bu konuyu doğrudan ele alıyor.',
    forYou: 'Sizin için gösteriliyor — üst çubuktaki 👨/🧕 anahtarıyla değiştirebilirsiniz.',
  ...
  ur: {
    ...
    lead: '"پاکیزگی ایمان کا نصف حصہ ہے۔" (صحیح مسلم 223)۔ اسلام بیت الخلا کے بعد صفائی کو ایک طریقے کے ساتھ عبادت سمجھتا ہے — اور یہ اہم ہے: نبی ﷺ نے خبردار کیا کہ قبر کے عذاب کا زیادہ تر حصہ پیشاب کے بارے میں لاپروائی کی وجہ سے ہوتا ہے (صحیح بخاری 218؛ سنن ابن ماجہ 348)۔ یہاں مکمل، عملی رہنمائی ہے — بشمول ان سوالات کے جو لوگ شرم کی وجہ سے نہیں پوچھتے۔',
