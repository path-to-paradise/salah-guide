...
const checklistItems = [
  {
    ...
    de: 'Lernen, wie man das Wudu vollzieht',
...
const C = {
  ...
  ur: {
    ...
    why2: '"قیامت کے دن انسان کے اعمال میں سب سے پہلے جس چیز کا حساب لیا جائے گا وہ اس کی نماز ہے۔ اگر وہ درست ہو تو وہ کامیاب ہو جائے گا۔" (جامع الترمذی 413)',
