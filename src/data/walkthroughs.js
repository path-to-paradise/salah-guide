...
const F = {
  ...
  nl: {
    ...
    rakah1: (aloud) =>
      `Rak'ah 1: reciteer zachtjes de openingsdua (Subhanaka…), de ta'awwudh en basmala, daarna Al-Fatiha en een korte soera ${aloud}.`,
    cycle:
    ...
    rakah2: (aloud) =>
      `Rak'ah 2: sta op met „Allahu Akbar" en herhaal — Al-Fatiha en een soera ${aloud}, dan ruku, rechtop staan en de twee sujud zoals daarvoor.`,
    firstTash:
    ...
    rakah3:
      "Rak'ah 3: alleen Al-Fatiha, in stilte (geen extra soera), dan ruku, rechtop staan en de twee sujud.",
    rakah34:
  ...
  ur: {
    ...
    silent: '(خاموشی سے)',
    pairs:
      'دو دو رکعتوں کے جوڑوں میں پڑھو: ہر جوڑا بالکل 2 رکعت کی نماز کی طرح ہے — دو رکعتیں، تشہد، درود، تسلیم — پھر اگر جاری رکھنا چاہو تو اگلے جوڑے کے لیے کھڑے ہو جاؤ۔',
  },
}
...
export const walkthroughs = {
  ...
  fajr: {
    label: {
      ...
      ur: 'فجر — 2 رکعتیں، مرحلہ بہ مرحلہ',
    },
    steps: both(
      2,
      {
      ...
      { aloud: true },
      {
        ...
        ur: [
          'سنت کی تجویز: فرض سے پہلے ہلکی 2 سنت رکعتیں پڑھو — "دنیا اور اس میں موجود ہر چیز سے بہتر" (صحیح مسلم 725)۔',
        ],
      },
    ),
  },
  dhuhr: {
    label: {
      ...
      ur: 'ظہر — 4 رکعتیں، مرحلہ بہ مرحلہ',
    },
    steps: both(
      4,
      {
      ...
      { aloud: false },
      {
        ...
        ur: ['اس کے ارد گرد سنت: پہلے 4 رکعتیں (دو دو یا چار اکٹھی) اور بعد میں 2 رکعتیں۔'],
      },
    ),
  },
  asr: {
    label: {
      ...
      ur: 'عصر — 4 رکعتیں، مرحلہ بہ مرحلہ',
    },
    steps: both(
      4,
      {
      ...
      { aloud: false },
      {
        ...
        ur: [
          'اختیاری: اس سے پہلے 4 رکعتیں (جامع ترمذی 430)۔ بعد میں کوئی سنت نہیں — ممنوعہ وقت شروع ہو جاتا ہے۔',
        ],
      },
    ),
  },
  maghrib: {
    label: {
      ...
      ur: 'مغرب — 3 رکعتیں، مرحلہ بہ مرحلہ',
    },
    steps: both(
      3,
      {
      ...
      { aloud: true },
      {
        ...
        ur: [
          'نوٹ: قراءت پہلی اور دوسری رکعت میں بلند آواز سے اور تیسری رکعت میں خاموشی سے ہوتی ہے۔ اس کے بعد 2 سنت رکعتیں پڑھو۔',
        ],
      },
    ),
  },
  isha: {
    label: {
      ...
      ur: 'عشاء — 4 رکعتیں، مرحلہ بہ مرحلہ',
    },
    steps: both(
      4,
      {
      ...
      { aloud: true },
      {
        ...
        ur: [
          'نوٹ: پہلی اور دوسری رکعت میں بلند آواز سے، تیسری اور چوتھی میں خاموشی سے۔ اس کے بعد 2 سنت رکعتیں پڑھو، اور رات کو وتر کے ساتھ مکمل کرو۔',
        ],
      },
    ),
  },
  ...
  jumuah: {
    ...
    steps: {
      en: [
        ...
        "When the imam sits on the mimbar (pulpit), the mu'adhin gives a second call to prayer — your cue that the khutbah is about to begin. Stop any voluntary prayer or conversation right away (Sahih al-Bukhari 916).",
        'Listen to both khutbahs in complete silence — even saying “quiet!” to someone forfeits the reward (Sahih al-Bukhari 934).',
        "After the iqamah, pray 2 rak'ahs of fard behind the imam. He recites aloud — typically Surah Al-Jumu'ah then Al-Munafiqun, or Al-A'la then Al-Ghashiyah (Sahih Muslim 879); you recite Al-Fatiha quietly and listen, and say “Amin” with him.",
      ...
      bg: [
        ...
        'Когато имамът седне на минбара, муезинът дава втори призив за намаз — твой знак, че хутбето скоро ще започне. Спри веднага всеки доброволен намаз или разговор (Сахих ал-Бухари 916).',
        'Слушай двете хутбета в пълно мълчание — дори да кажеш „тихо!“ на някого, изгубваш наградата (Сахих ал-Бухари 934).',
        'След икамета кланяй 2 рекята фарз зад имама. Той чете на глас — обикновено Сура Ал-Джумуа, после Ал-Мунафикун, или Ал-Аля, после Ал-Гашия (Сахих Муслим 879); ти чети Ал-Фатиха тихо, слушай и кажи „Амин“ с него.',
      ...
      fr: [
        ...
        "Quand l'imam s'assoit sur le minbar (chaire), le mu'adhin lance un second appel à la prière — c'est ton signal que la khutbah va commencer. Arrête aussitôt toute prière volontaire ou conversation (Sahih al-Bukhari 916).",
        'Écoute les deux khutbahs en silence complet — même dire « chut ! » à quelqu\'un fait perdre la récompense (Sahih al-Bukhari 934).',
        "Après l'iqamah, prie 2 rak'ahs de fard derrière l'imam. Il récite à voix haute — généralement la sourate Al-Jumu'ah puis Al-Munafiqun, ou Al-A'la puis Al-Ghashiyah (Sahih Muslim 879) ; toi, récite Al-Fatiha silencieusement et écoute, et dis « Amin » avec lui.",
      ...
      de: [
        ...
        'Wenn sich der Imam auf die Minbar (Kanzel) setzt, ruft der Muezzin einen zweiten Gebetsruf — dein Zeichen, dass die Khutbah gleich beginnt. Beende sofort jedes freiwillige Gebet oder Gespräch (Sahih al-Bukhari 916).',
        ...
        'Nach der Iqamah bete 2 Rak\'ah Fard hinter dem Imam. Er rezitiert laut — meist Surah Al-Jumu\'ah, dann Al-Munafiqun, oder Al-A\'la, dann Al-Ghashiyah (Sahih Muslim 879); du rezitierst Al-Fatiha leise und hörst zu, und sagst „Amin“ mit ihm.',
      ...
      nl: [
        ...
        'Onderweg en tijdens het wachten: stuur overvloedig salawat en lees Soera Al-Kahf (het reciteren ervan op vrijdag is een licht tussen de twee vrijdagen — al-Hakim, sahih volgens al-Albani).',
        ...
        "Wanneer de imam op de minbar (preekstoel) gaat zitten, roept de mu'adhin een tweede oproep tot gebed — jouw teken dat de khutbah zo begint. Stop meteen met elk vrijwillig gebed of gesprek (Sahih al-Bukhari 916).",
        ...
        'Na de iqamah bid je 2 rak\'ahs fard achter de imam. Hij reciteert hardop — meestal Soera Al-Jumu\'ah, dan Al-Munafiqun, of Al-A\'la, dan Al-Ghashiyah (Sahih Muslim 879); jij reciteert Al-Fatiha stil en luistert, en zegt "Amin" met hem mee.',
      ...
      tr: [
        ...
        "İmam minbere oturduğunda, müezzin ikinci bir ezan okur — bu, hutbenin başlamak üzere olduğunun işaretidir. Nafile namazı veya konuşmayı hemen bırak (Sahih Buhari 916).",
        'Her iki hutbeyi de tam bir sessizlik içinde dinle — birine "sus!" demek bile mükafatı kaybettirir (Sahih Buhari 934).',
        'İkametten sonra imamın arkasında 2 rekat farz kıl. İmam sesli okur — genellikle Cuma Suresi ardından Münafikun, ya da A\'la ardından Gaşiye (Sahih Müslim 879); sen Fatiha\'yı sessizce oku ve dinle, onunla birlikte "Amin" de.',
      ...
      ur: [
        'گھر سے تیاری کرو: غسل کرو، بہترین کپڑے پہنو، خوشبو لگاؤ (مرد حضرات)، اور جلدی جاؤ (صحیح البخاری 883)۔',
        ...
        'مسجد میں: بیٹھنے سے پہلے تحیۃ المسجد کی 2 رکعتیں پڑھو — چاہے خطبہ شروع ہو چکا ہو (صحیح مسلم 875)۔',
        'جب امام منبر پر بیٹھ جائے تو مؤذن دوسری اذان دیتا ہے — یہ اس بات کی علامت ہے کہ خطبہ شروع ہونے والا ہے۔ فوراً کوئی بھی نفل نماز یا گفتگو روک دو (صحیح البخاری 916)۔',
        'دونوں خطبے مکمل خاموشی سے سنو — کسی کو "خاموش!" کہنا بھی ثواب ضائع کر دیتا ہے (صحیح البخاری 934)۔',
        'اقامت کے بعد امام کے پیچھے 2 رکعت فرض پڑھو۔ وہ بلند آواز سے پڑھتا ہے — عام طور پر سورۃ الجمعہ پھر سورۃ المنافقون، یا سورۃ الاعلیٰ پھر سورۃ الغاشیہ (صحیح مسلم 879)؛ تم خاموشی سے سورۃ الفاتحہ پڑھو اور سنو، اور اس کے ساتھ "آمین" کہو۔',
        'نماز خود بالکل کسی بھی 2 رکعت فرض کی طرح ہے: دو مکمل رکعتیں → آخری قعدہ (تشہد، درود، دعا) → تسلیم۔',
        'اس کے بعد: اذکار، پھر سنت — مسجد میں 4 رکعتیں یا گھر میں 2 رکعتیں (صحیح مسلم 881)۔',
      ],
    },
  },
  janazah: {
    label: {
      ...
      ur: 'جنازہ — 4 تکبیریں، صرف کھڑے ہو کر',
    },
    steps: {
      en: [
      ...
      ur: [
        ...
        'تیسری تکبیر: میت کے لیے خلوص دل سے دعا کرو — مثلاً "اللہم اغفر لحینا و میتنا..." (اے اللہ، ہمارے زندوں اور مردوں کو بخش دے...) (سنن ابی داؤد 3201)۔',
  ...
  witr: {
    ...
    steps: {
      ...
      fr: [
        ...
        "Dua al-Qunut : dans la dernière rak'ah, lève les mains et récite « Allahumma-hdini fiman hadayt… » — avant le ruku (après la récitation) ou après s'être relevé du ruku ; les deux sont pratiqués. Texte complet sur la page Douas et sourates.",
      ...
      nl: [
        'Manier 1 (2+1): bid 2 rak\'ahs precies zoals elk gebed van 2 rak\'ahs, eindigend met tasleem. Bid dan 1 aparte rak\'ah: takbir → Al-Fatiha + een soera → qunut (zie hieronder) → ruku → twee sujud → zitten → tasleem.',
        'Manier 2 (3 samen): bid 3 rak\'ahs met slechts één zitting aan het einde (ga niet zitten na rak\'ah 2, zodat het niet op Maghrib lijkt): Fatiha + soera in alle drie, dan de laatste zitting en tasleem.',
        'De sunnah-soera\'s: Al-A\'la in de 1e, Al-Kafirun in de 2e, Al-Ikhlas in de 3e (Sunan an-Nasa\'i 1729).',
      ...
      ur: [
        'پہلا طریقہ (2+1): بالکل کسی بھی 2 رکعت نماز کی طرح 2 رکعتیں پڑھو، تسلیم پر ختم کرو۔ پھر 1 الگ رکعت پڑھو: تکبیر → سورۃ الفاتحہ + ایک سورت → قنوت (نیچے دیکھیں) → رکوع → دو سجدے → بیٹھنا → تسلیم۔',
        'دوسرا طریقہ (تینوں اکٹھی): آخر میں صرف ایک بار بیٹھ کر 3 رکعتیں پڑھو (دوسری رکعت کے بعد نہ بیٹھو، تاکہ یہ مغرب جیسی نہ لگے): تینوں میں فاتحہ + سورت، پھر آخری قعدہ اور تسلیم۔',
        'سنت سورتیں: پہلی میں الاعلیٰ، دوسری میں الکافرون، تیسری میں الاخلاص (سنن نسائی 1729)۔',
        ...
        'تسلیم کے بعد تین بار کہو: "سبحان الملک القدوس" (سنن نسائی 1732)۔',
        'وقت: عشاء کے بعد سے صبح صادق تک۔ اگر جاگنے کا یقین نہ ہو تو سونے سے پہلے پڑھ لو؛ اگر جاگنے کا یقین ہو تو اسے رات کی آخری نماز بناؤ (صحیح البخاری 998)۔',
      ],
    },
  },
  eid: {
    label: {
      ...
      ur: 'عید — اضافی تکبیروں کے ساتھ 2 رکعتیں',
    },
    steps: {
      en: [
      ...
      nl: [
        ...
        'Rak\'ah 1: na de openingstakbir zegt de imam 7 extra takbirs — hef bij elke je handen. Daarna Al-Fatiha en een soera (hardop; Al-A\'la is sunnah).',
        'Voltooi de rak\'ah normaal: ruku, staan, twee sujud.',
        'Rak\'ah 2: na het staan, 5 extra takbirs vóór de recitatie, dan Al-Fatiha en een soera (Al-Ghashiyah is sunnah), en de rak\'ah wordt normaal voltooid.',
      ...
      ur: [
        'جانے سے پہلے: غسل کرو اور بہترین کپڑے پہنو۔ عید الفطر — جانے سے پہلے کھجوریں کھاؤ؛ عید الاضحیٰ — کھانا نماز کے بعد تک مؤخر کرو (جامع ترمذی 542)۔ تکبیریں کہتے ہوئے جاؤ: "اللہ اکبر، اللہ اکبر، لا الہ الا اللہ..."۔',
        'اس سے پہلے کوئی اذان، اقامت یا سنت نماز نہیں ہے۔',
        'پہلی رکعت: ابتدائی تکبیر کے بعد امام 7 اضافی تکبیریں کہتا ہے — ہر ایک کے ساتھ ہاتھ اٹھاؤ۔ پھر سورۃ الفاتحہ اور ایک سورت (بلند آواز سے؛ سورۃ الاعلیٰ سنت ہے)۔',
        'رکعت معمول کے مطابق مکمل کرو: رکوع، قیام، دو سجدے۔',
        'دوسری رکعت: کھڑے ہونے کے بعد قراءت سے پہلے 5 اضافی تکبیریں، پھر سورۃ الفاتحہ اور ایک سورت (سورۃ الغاشیہ سنت ہے)، اور رکعت معمول کے مطابق مکمل ہوتی ہے۔',
  ...
  rawatib: {
    ...
    steps: both(
      2,
      {
        ...
        ur: 'وہ سنت جو تم پڑھ رہے ہو (مثلاً "فجر کی سنت کی 2 رکعتیں")',
      },
      { aloud: false, withAdhkar: false },
      {
        ...
        ur: [
          'ظہر/عصر سے پہلے کی 4 رکعتیں دو دو کر کے پڑھی جاتی ہیں (یا ایک ساتھ چار، پہلے تشہد کے ساتھ)۔ سنت نمازوں میں قراءت خاموشی سے ہوتی ہے، بہت سے علماء کے نزدیک رات میں بھی — رات میں بلند آواز سے پڑھنا بھی درست ہے۔',
          'فجر کی سنت میں نبی ﷺ اکثر سورۃ الکافرون (109) اور سورۃ الاخلاص (112) پڑھتے تھے — صحیح مسلم 726۔',
        ],
      },
    ),
  },
  tarawih: {
    ...
    steps: {
      ...
      ur: [
        'پہلے عشاء پڑھو (تراویح اس کے بعد آتی ہے)، اس کی 2 سنت رکعتوں کے ساتھ۔',
        'تراویح جوڑوں میں پڑھی جاتی ہے: ہر 2 رکعتیں تشہد اور تسلیم کے ساتھ ایک مکمل نماز ہیں — بالکل 2 رکعت کا نمونہ۔',
        'ہر 4 رکعتوں کے بعد مختصر آرام کرو (یہی وقفہ "ترویحہ" ہے جس سے اس نماز کا نام پڑا)۔',
        'اپنی مسجد کے مطابق 8 یا 20 رکعتیں جاری رکھو — دونوں مستند طریقے ہیں؛ نبی ﷺ 8 لمبی رکعتیں پڑھتے تھے (صحیح البخاری 1147)، اور 20 رکعتیں حضرت عمر (رضی اللہ عنہ) کے دور میں رائج ہوئیں۔',
        ...
        '"جو شخص امام کے ساتھ کھڑا رہے یہاں تک کہ وہ ختم کرے، اس کے لیے پوری رات کی نماز لکھی جاتی ہے۔" (جامع ترمذی 806)',
      ],
    },
  },
  ...
  tahajjud: {
    ...
    steps: {
      ...
      ur: [
        ...
        'رات کی نماز شروع کرنے کے لیے ہلکی، مختصر 2 رکعتوں سے آغاز کرو (صحیح مسلم 767)۔',
        'پھر جوڑوں میں پڑھو — 2 رکعت کا نمونہ — لمبی، آہستہ قراءت کے ساتھ: زیادہ دیر کھڑے رہو، جو یاد ہے وہ پڑھو، اور سجدوں کو دعا کے ساتھ طویل ہونے دو۔',
        'نبی ﷺ کی معمول کی تعداد 8 رکعتیں (4 جوڑے) تھی، لیکن ایک جوڑا بھی قیام اللیل شمار ہوتا ہے — مقدار سے زیادہ معیار اہم ہے۔',
        'آخری تہائی میں دعا قبول ہوتی ہے: "کون ہے جو مجھے پکارے تاکہ میں اسے جواب دوں؟" (صحیح البخاری 1145)۔ کسی بھی زبان میں کھل کر دعا مانگو۔',
        'اگر ابھی تک نہیں پڑھی تو وتر (1 یا 3) کے ساتھ رات مکمل کرو۔',
      ],
    },
  },
  duha: {
    ...
    steps: {
      ...
      nl: [
        ...
        "Bid 2 rak'ahs volgens het standaard sjabloon van 2 rak'ahs (stille recitatie, willekeurige soera's).",
      ...
      ur: [
        'سورج مکمل طور پر طلوع ہونے تک انتظار کرو — طلوع آفتاب کے تقریباً 15-20 منٹ بعد۔ بہترین وقت وہ ہے جب صبح گرم ہو چکی ہو، ظہر کے قریب آنے سے پہلے۔',
        'معیاری 2 رکعت کے نمونے کے مطابق 2 رکعتیں پڑھو (خاموش قراءت، کوئی بھی سورتیں)۔',
        'اگر چاہو تو جوڑوں میں مزید بڑھاؤ — 4، 6 یا 8 رکعتیں سب مروی ہیں؛ نبی ﷺ نے مکہ کی فتح کے دن 8 رکعتیں پڑھیں (صحیح مسلم 336)۔',
        'دو رکعتیں تمہارے جسم کے ہر جوڑ پر واجب روزانہ صدقے کے لیے کافی ہیں (صحیح مسلم 720)۔',
      ],
    },
  },
  istikhara: {
    ...
    steps: {
      ...
      fr: [
        ...
        "Après le tasleem, lève les mains et récite la dua de l'Istikhara (Sahih al-Bukhari 1166) — texte complet sur la page Douas et sourates — en nommant ta question aux deux endroits indiqués (« hadhal-amr » — cette affaire).",
      ...
      ur: [
        ...
        'معیاری 2 رکعت کے نمونے کے مطابق 2 نفل رکعتیں پڑھو (ممنوعہ اوقات کے علاوہ کسی بھی وقت)۔',
        'تسلیم کے بعد ہاتھ اٹھاؤ اور استخارے کی دعا پڑھو (صحیح البخاری 1166) — مکمل متن دعاؤں کے صفحے پر — اپنے معاملے کا نام دونوں مقررہ جگہوں پر لو ("ہذا الامر" — یہ معاملہ)۔',
  ...
  taubah: {
    ...
    steps: {
      ...
      fr: [
        ...
        'Après le tasleem, cherche sincèrement le pardon : Sayyid al-Istighfar (Sahih al-Bukhari 6306) est la meilleure formule — texte complet sur la page Douas et sourates. Pleure si tu le peux ; ressens-le pleinement.',
      ...
      ur: [
        ...
        'وضو کرو، اور اچھی طرح کرو — بغیر جلدی کے، مکمل، جیسا کہ خود حدیث میں بیان ہوا ہے (سنن ابی داؤد 1521)۔',
        'معیاری 2 رکعت کے نمونے کے مطابق پوری توجہ کے ساتھ 2 رکعتیں پڑھو — یہ نماز اس ذات سے تمہاری ملاقات ہے جس کی طرف تم لوٹ رہے ہو۔',
        'تسلیم کے بعد خلوص دل سے مغفرت طلب کرو: سید الاستغفار (صحیح البخاری 6306) بہترین دعا ہے — مکمل متن دعاؤں کے صفحے پر ہے۔ اگر رو سکو تو روؤ؛ پورے دل سے اس کا مطلب سمجھو۔',
        ...
        '"...سوائے اس کے کہ اللہ اسے معاف کر دے۔" (سنن ابی داؤد 1521) — پھر نبی ﷺ نے یہ پڑھا: "اور وہ لوگ جو جب کوئی بے حیائی کا کام کر بیٹھیں یا اپنی جانوں پر ظلم کر لیں تو اللہ کو یاد کرتے ہیں اور اپنے گناہوں کی معافی مانگتے ہیں..." (قرآن 3:135)۔',
      ],
    },
  },
  twoRakahNafl: {
    label: {
      ...
      ur: 'سادہ 2 رکعت نفل (تحیہ، وضو کے بعد...)',
    },
    steps: both(
      2,
      {
        ...
        ur: 'وہ نفل جو تم پڑھ رہے ہو (مثلاً "تحیۃ المسجد کی 2 رکعتیں")',
      },
      { aloud: false, withAdhkar: false },
      {
        en: [
        ...
        nl: [
          "Dat is alles — willekeurige korte soera's, zonder haast gebeden. Hetzelfde sjabloon dient voor tahiyyat al-masjid, de 2 na wudu, en elk algemeen nafl-gebed.",
        ],
        tr: [
        ...
        ur: [
          'بس اتنا ہی — کوئی بھی مختصر سورتیں، بغیر جلدی کے پڑھی جائیں۔ یہی طریقہ تحیۃ المسجد، وضو کے بعد کی 2 رکعتوں، اور ہر عام نفل کے لیے کارآمد ہے۔',
        ],
      },
    ),
  },
  kusuf: {
    ...
    steps: {
      ...
      fr: [
        "Quand l'éclipse commence, rejoins la prière en congrégation (ou prie seul). Fais l'intention de la prière de l'éclipse — 2 rak'ahs, mais chacune avec deux positions debout et deux rukus.",
      ...
      ur: [
        'جب گرہن شروع ہو تو جماعت میں جمع ہو جاؤ (یا اکیلے پڑھو)۔ گرہن کی نماز کی نیت کرو — 2 رکعتیں، لیکن ہر ایک میں دو قیام اور دو رکوع۔',
        ...
        'اس کے ساتھ: گرہن ختم ہونے تک ذکر، دعا، تکبیر اور صدقہ بڑھاؤ (صحیح البخاری 1044)۔',
      ],
    },
  },
  istisqa: {
    ...
    steps: {
      ...
      ur: [
        'برادری کھلی جگہ پر نکلتی ہے، عاجزی اور سادگی سے ملبوس، توبہ اور صدقہ دینے کے بعد — بارش گناہوں کی وجہ سے روکی جاتی ہے اور استغفار سے کھنچی آتی ہے (قرآن 71:10-11)۔',
        'عید کی نماز کی طرح 2 رکعتیں پڑھو (اکثر مسالک کے مطابق اضافی تکبیروں کے ساتھ)، قراءت بلند آواز سے۔',
        'امام ایک خطبہ دیتا ہے جس میں استغفار اور بارش کی دعا غالب ہوتی ہے، مثلاً "اللہم اسقنا الغیث..." (اے اللہ، ہمیں بارش عطا فرما...)۔',
        'امام قبلہ رخ ہو کر اپنی چادر الٹ دیتا ہے — یہ امید کی علامت ہے کہ اللہ حالت بدل دے — اور سب طویل دعا میں ہاتھ اٹھاتے ہیں (صحیح البخاری 1012)۔',
      ],
    },
  },
}
